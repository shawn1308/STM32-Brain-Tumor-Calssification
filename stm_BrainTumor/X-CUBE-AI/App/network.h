...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "bt_55_model"
...
#define AI_NETWORK_IN_1_HEIGHT      (55)
#define AI_NETWORK_IN_1_WIDTH       (55)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (55 * 55 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  (12100)
...
#define AI_NETWORK_OUT_1_CHANNEL     (43)
#define AI_NETWORK_OUT_1_SIZE        (43)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (172)
